  ...
  return (
    <View style={{flex: 1, justifyContent: 'center'}}>
      <Image
        ...
        source={{
          uri: 'https://mblogthumb-phinf.pstatic.net/MjAxOTAxMjhfMjcy/MDAxNTQ4NjUzODQwNDU1.TGZerrlJmY3RSyDS6Tn2N6CIHqgiwLpgKDBNKy_iaQEg.UdaBm47Y13IfcqTEkkoMcJtJXnf3rKypl23jPqit9akg.JPEG.ks_enter/20190111_145645.jpg?type=w2',
        }}
      />
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          Linking.openURL(
            'https://sejong.korea.ac.kr/mbshome/mbs/kr/subview.do?id=kr_050705030000',
          )
        }>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          Linking.openURL(
            'https://sejong.korea.ac.kr/mbshome/mbs/kr/subview.do?id=kr_050705060000',
          )
        }>
