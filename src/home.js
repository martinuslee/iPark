      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.topContainer}>
          <View
            ...
            {users_member.reserve_product == '관리자' ||
            users_member.reserve_product == '근로장학생' ? (
              <View
                style={{
                  flex: 1,
                  justifyContent: 'center',
              ...
              <View style={styles.topContainerSecond}>
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  {users_member.day_pass == true ? (
                    <Text style={{backgroundColor: 'red', borderRadius: 10}}>
                      {' '}
                      1일권{' '}
                    </Text>
                  ) : (
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <View style={styles.iconContainer}>
                  <Icon name="lightbulb-o" size={30} color="#ffffff" />
                </View>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <View style={styles.iconContainer}>
                  <Icon name="child" size={30} color="#ffffff" />
                </View>
        ...
        <View style={styles.barContainer}>
          ...
          <Text style={{color: 'yellow', fontSize: 12, marginVertical: 10}}>
            * 사용 인원이 50명을 초과하면, 센터 이용에 불편함이 있을 수
            있습니다. 이용하시기 전, 참고하신 후 이용하시길 바랍니다.{' '}
          </Text>
        </View>
        ...
        <View style={styles.bottomContainter}>
          <TouchableOpacity
            style={styles.menuButton}
            onPress={() => navigation.navigate('infoIpark')}>
            <View style={styles.iconContainer}>
          ...
          <TouchableOpacity
            style={styles.menuButton}
            onPress={() => navigation.navigate('statisticalStatus')}>
            <View style={styles.iconContainer}>
          ...
          <TouchableOpacity
            style={styles.menuButton}
            onPress={() => Alert.alert('새로운 기능들과 함께 준비 중입니다.')}>
            <View style={styles.iconContainer}>
              <Icon name="flask" size={30} color="#ffffff" />
            </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Platform.OS === 'ios'
                ? Linking.openURL('mailto:eet43@korea.ac.kr')
                : Linking.openURL('mailto:cjh970422@korea.ac.kr')
            }
            title="support@example.com">
            <View style={styles.iconContainer}>
              <Icon name="comments-o" size={30} color="#ffffff" />
            </View>
